    ...
    <Container>
      ...
      <ContainerBody>
        ...
        <Paragraph>
          ...
          trabalhar devido a uma deficiência, incapacidade de encontrar trabalho
          ou por causa de uma doença, você terá a segurança de saber que poderá
          solicitar os benefícios, se necessário. Além disso, se você for
          demitido injustamente de seu emprego, poderá solicitar uma
          indenização.
        </Paragraph>
      </ContainerBody>
      <ContainerFooter>
